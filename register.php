...
<body>
    ...
    <div>
        <form class="form" action="handlers/handleUser/handleRegister.php" method="post">
            ...
            <input class="input" placeholder="Enter Confirm Password" type="password" name="cpassword" id="">
            <input class="input" placeholder="Enter your phone " type="text" name="phone" id="">
            <input class="input" placeholder="Enter your address " type="text" name="address" id="">
